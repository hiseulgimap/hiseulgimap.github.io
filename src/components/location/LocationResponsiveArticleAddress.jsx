...
import styles from './LocationResponsiveArticleAddress.module.css';

function LocationResponsiveArticleAddress({ location }) {
...
export default LocationResponsiveArticleAddress;

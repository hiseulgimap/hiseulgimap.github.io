...
import styles from './LocationResponsiveArticleInformation.module.css';

function LocationResponsiveArticleInformation({ location }) {
...
export default LocationResponsiveArticleInformation;
